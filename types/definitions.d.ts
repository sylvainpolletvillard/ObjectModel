...
export type FromObjectPropertyDefinition<T> = T extends ArrayModel<infer U> ? FromDefinition<U>[]
                                            : FromDefinition<T>

export type FromObjectModelDefinition<D extends object> = { [K in keyof D]: FromObjectPropertyDefinition<D[K]> }
